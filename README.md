...
| showAuxSwitch         | Display an auxiliary water shutoff switch. This is useful in Apple's Home application. Other Homekit applications such as Eve expose the Flo valve for automation. Default to <i>false</i>, this is an optional value.|
